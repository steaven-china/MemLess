...
function mapManager(value: unknown, filePath: string, fieldPath: string): DeepPartial<ManagerConfig> {
  ...
  assignBoolean(output, "lowEntropyTriggerEnabled", table.lowEntropyTriggerEnabled, filePath, `${fieldPath}.lowEntropyTriggerEnabled`);
  assignNumber(output, "lowEntropyWindowSize", table.lowEntropyWindowSize, filePath, `${fieldPath}.lowEntropyWindowSize`);
  assignNumber(output, "lowEntropyMinSignals", table.lowEntropyMinSignals, filePath, `${fieldPath}.lowEntropyMinSignals`);
  assignNumber(output, "lowEntropyNoveltyMax", table.lowEntropyNoveltyMax, filePath, `${fieldPath}.lowEntropyNoveltyMax`);
  assignNumber(output, "lowEntropyRetrievalOverlapMin", table.lowEntropyRetrievalOverlapMin, filePath, `${fieldPath}.lowEntropyRetrievalOverlapMin`);
  assignNumber(output, "lowEntropyPredictionWeightMax", table.lowEntropyPredictionWeightMax, filePath, `${fieldPath}.lowEntropyPredictionWeightMax`);
  assignNumber(output, "lowEntropyRelationNewRateMax", table.lowEntropyRelationNewRateMax, filePath, `${fieldPath}.lowEntropyRelationNewRateMax`);
  assignNumber(output, "lowEntropyGraphCoverageMax", table.lowEntropyGraphCoverageMax, filePath, `${fieldPath}.lowEntropyGraphCoverageMax`);
  assignNumber(output, "lowEntropyRelationConfidenceMax", table.lowEntropyRelationConfidenceMax, filePath, `${fieldPath}.lowEntropyRelationConfidenceMax`);
  assignNumber(output, "lowEntropySoftStreakK", table.lowEntropySoftStreakK, filePath, `${fieldPath}.lowEntropySoftStreakK`);
  ...
  assignNumber(output, "relationTriggerCooldownSeconds", table.relationTriggerCooldownSeconds, filePath, `${fieldPath}.relationTriggerCooldownSeconds`);
  assignNumber(output, "relationTriggerLowInfoThreshold", table.relationTriggerLowInfoThreshold, filePath, `${fieldPath}.relationTriggerLowInfoThreshold`);
  assignNumber(output, "relationTriggerHighEntropyThreshold", table.relationTriggerHighEntropyThreshold, filePath, `${fieldPath}.relationTriggerHighEntropyThreshold`);
  assignNumber(output, "relationTriggerShortChainMaxSize", table.relationTriggerShortChainMaxSize, filePath, `${fieldPath}.relationTriggerShortChainMaxSize`);
  assignNumber(output, "relationMinConfidence", table.relationMinConfidence, filePath, `${fieldPath}.relationMinConfidence`);
